...
addon = xbmcaddon.Addon('plugin.video.JMDL')
...
SOURCES = [{"description": ": Lista de Canales para el Livestreamspro :", "title": "JMDL ", "url": "http://listajmdl.proyectoluzdigital.com/jmdl.xml", "fanart": "C:\\Users\\JOSE\\AppData\\Roaming\\Kodi\\addons\\PLUGIN.JMDL-master\\fanart.jpg", }]

# http://i.imgur.com/zaHkTuS.pnghttp://i.imgur.com/zaHkTuS.png
# http://i.imgur.com/ZoRVQfN.png
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.JMDL-%s]: %s" %(addon_version, string))
